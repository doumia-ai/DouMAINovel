    ...
    >
      <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
        ...
        <ThemedModal
          ...
          footer={null}
          {...getResponsiveModalProps(isMobile, 600)}
        >
        ...
        >
            <div style={{ textAlign: 'center', padding: '40px 20px' }}>
              <DownloadOutlined style={{ fontSize: 48, color: 'var(--color-info)', marginBottom: 16 }} />
              ...
              <Divider />
              <div style={{ textAlign: 'left', fontSize: 12, color: 'var(--color-text-secondary)' }}>
